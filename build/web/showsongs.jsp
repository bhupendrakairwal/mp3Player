<%-- 
    Document   : showsong
    Created on : Aug 3, 2020, 10:01:25 PM
    Author     : Lenovo
--%>
  ...
  <div class="album-tracks">
     ...
     <div class="output-group col-sm-7">
                                       ...
                                       <table width=100% border=0 cellspacing=5>
                                                ...
                                                <ol>
                                                    <td style="font-size:25px"><p><li><%out.println(""+rs1.getString(5)+"");%></li></p></td><td><%out.println(""+rs1.getString(6)+"");%></td><td><button type="button" class="btn btn-primary"><a href="mp3player.jsp?Acode=<%=Acode%>&Scode=<%=Scode%>&Catcode=<%=Catcode%>">Play</a></button></td><br>
                                                </tr>
                                                <ol>
                                                    </list>
                                              </table>
