<%-- 
    Document   : delete
    Created on : Jul 25, 2020, 9:28:54 PM
    Author     : Lenovo
--%>
                                   ...
                                   <div class="output-group col-sm-7">
                                         <table width=60%>
                                                <tr>
                                                  ...
                                                  <td><button class="btn btn-primary" type="submit"><a href='deletecheck.jsp?id=<%=rs.getString(1)%>'><font color="white">Delete</font></a></button></td>
                                                </tr>
                                              </table>
                                    </div>
                                         <div class="clearfix"></div>
