<%-- 
    ...
    Created on : Jul 25, 2020, 9:23:47 PM
    Author     : Lenovo
--%>
...
<body>
	<div class="wrapper">
		...
		<div class="main-panel">
          ...
          <form action="addsongcheck.jsp?id=<%=Acode%>" method="post">
    <div  class="input-group col-sm-6 mb-3">
        <h3>Song Name : </h3>&nbsp;&nbsp;&nbsp;
        <input type="text" maxlength="100" name="Sname"  class="form-control" placeholder="Song Name" ><br>
        </div>
      <div  class="input-group col-sm-7 mb-3">
          <h3>Discription : </h3>&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="text" maxlength="100" name="about"  class="form-control" placeholder="Deteils" ><br>&nbsp;&nbsp;&nbsp;
      ...
      <div class="col-sm-7">
     <div class="output-group col-sm-12 mb-3">
                                     <%
                                       ...
                                       <table width=100% border=0 cellspacing=5>
                                                ...
                                                <list class="list-group">
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td style="font-size:25px"><p><li><%out.println(""+rs.getString(5)+"");%></li></p></td><td><%out.println(""+rs.getString(6)+"");%></td><td><button type="button"><a href="">Delete</a></button></td>
