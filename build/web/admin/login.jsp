<%-- 
    Document   : login
    Created on : Jul 23, 2020, 7:38:04 PM
    Author     : Lenovo
--%>
...
%>
				...
				<div class="form-action mb-3">
                                    <input type="submit"  value="Sign In" class="btn btn-primary btn-rounded btn-login">
				</div>
		...
		<div class="container container-signup animated fadeIn">
			...
			<div class="login-form">
				...
				<div class="form-action">
					...
					<a href="index.jsp" class="btn btn-primary btn-rounded btn-login">Sign Up</a>
				</div>
			</div>
		</div>
	</div>
