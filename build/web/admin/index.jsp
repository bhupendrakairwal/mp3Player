<%-- 
    Document   : index
    Created on : Jul 23, 2020, 7:33:47 PM
    Author     : Lenovo
--%>
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<li>
									<div class="user-box">
										...
										<div class="u-text">
											<h4><%out.println(""+rs.getString(3)+"");%></h4>
											<p class="text-muted"><%out.println(""+rs.getString(1)+"");%></p><a href="profile.html" class="btn btn-rounded btn-danger btn-sm">View Profile</a>
										</div>
									</div>
								</li>
								<li>
						...
						<li class="nav-item">
							...
							<div class="collapse" id="forms">
								<ul class="nav nav-collapse">
									<li>
										<a href="addcat.jsp">
											<span class="sub-item">Add Catagory </span>
									...
									<li>
										<a href="delete.jsp">
											<span class="sub-item">Delete Catagory </span>
						...
						<li class="nav-item">
							...
							<div class="collapse" id="tables">
								<ul class="nav nav-collapse">
									<li>
										<a href="addalbum.jsp">
											<span class="sub-item">Add album</span>
										</a>
									</li>
									<li>
										<a href="remove.jsp">
											<span class="sub-item">Remove album</span>
										</a>
									</li>
								</ul>
							</div>
