...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(email!=null&&session.getAttribute(email)!=null){
      ...
      out.write("                        <form method=\"post\" action=\"logincheck2.jsp\">\n");
      ...
      out.write("\t\t\t\t\t<input  name=\"email\" type=\"email\" class=\"form-control input-border-bottom\" required>\n");
      out.write("\t\t\t\t\t<label  class=\"placeholder\">Email</label>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("                                ");
      ...
      out.write("\t\t\t\t\t<label  class=\"placeholder\">Password</label>\n");
      ...
      out.write("                                    <button type=\"submit\" class=\"btn btn-primary btn-rounded btn-login\">Sign In</button>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"login-account\">\n");
      out.write("\t\t\t\t\t<span class=\"msg\">Don't have an account yet ?</span>\n");
      out.write("\t\t\t\t\t<a onClick=\"myFunction();\" id=\"show-signup\" class=\"link\"><button>Sign Up</button></a>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("                               \n");
      out.write("\t\t\t</div>\n");
      out.write("                                 </form>\n");
      out.write("\t\t</div>\n");
      out.write("\n");
      out.write("\t\t<div  id=\"signup\" class=\"container container-signup animated fadeIn\">\n");
      out.write("\t\t\t<h3 class=\"text-center\">Sign Up</h3>\n");
      out.write("\t\t\t<div class=\"login-form\">\n");
      out.write("                            <form method=\"post\" action=\"registercheck.jsp\">\n");
      out.write("\t\t\t\t<div class=\"form-group form-floating-label\">\n");
      out.write("\t\t\t\t\t<input   name=\"name\" type=\"text\" class=\"form-control input-border-bottom\" required>\n");
      out.write("\t\t\t\t\t<label  class=\"placeholder\">Fullname</label>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"form-group form-floating-label\">\n");
      out.write("\t\t\t\t\t<input   name=\"email\" type=\"email\" class=\"form-control input-border-bottom\" required>\n");
      out.write("\t\t\t\t\t<label  class=\"placeholder\">Email</label>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"form-group form-floating-label\">\n");
      out.write("\t\t\t\t\t<input   name=\"password\" type=\"password\" class=\"form-control input-border-bottom\" required>\n");
      out.write("\t\t\t\t\t<label  class=\"placeholder\">Password</label>\n");
      out.write("\t\t\t\t\t<div class=\"show-password\">\n");
      out.write("\t\t\t\t\t\t<i class=\"flaticon-interface\"></i>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"form-group form-floating-label\">\n");
      out.write("\t\t\t\t\t<input   name=\"cpassword\" type=\"password\" class=\"form-control input-border-bottom\" required>\n");
      out.write("\t\t\t\t\t<label  class=\"placeholder\">Confirm Password</label>\n");
      out.write("\t\t\t\t\t<div class=\"show-password\">\n");
      out.write("\t\t\t\t\t\t<i class=\"flaticon-interface\"></i>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t<a href=\"login.jsp\" id=\"show-signin\" class=\"btn btn-danger btn-rounded btn-login mr-3\">Cancel</a>\n");
      out.write("                                        <button type=\"submit\" class=\"btn btn-primary btn-rounded btn-login\">Sign Up</button>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</form>\n");
      out.write("                        \n");
      out.write("                        </div>\n");
      ...
      out.write("  document.getElementById(\"signup\").HTML();\n");
      out.write("}\n");
      out.write("</script>\n");
      out.write("\n");
