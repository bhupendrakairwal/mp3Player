...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  if(email!=null&&session.getAttribute(email)!=null){
     ...
     Class.forName("com.mysql.jdbc.Driver");
      ...
      out.write("\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("                            <!-- user name at header-->\n");
      out.write("\t\t\t\t<div class=\"top-header-right\">\n");
      out.write("\t\t\t\t  <ul id=\"name\">\n");
      out.write("                                    <li><a href=\"login.jsp\" onClick=\"myFunction()\" class=\"dropbtn\">Login<i id=\"name2\" class='fas fa-user-alt' style='font-size:20px'></i></a></li>    \n");
      out.write("                                  </ul>\n");
      out.write("\t\t\t\t\t\t\n");
      out.write("\t\t\t\t</div>\n");
      ...
      out.write("                                                <li><a href=\"login.jsp\">Create Playlist</a></li>\n");
      out.write("\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"clear\"> </div>\n");
      out.write("\t\t\t</div>\n");
