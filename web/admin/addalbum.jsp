<%-- 
    Document   : addalbum
    Created on : Jul 25, 2020, 9:25:49 PM
    Author     : Lenovo
--%>
...
<body>
  ...
  <form action="addalbumcheck.jsp" method="post">
    <div  class="input-group col-sm-6 mb-3">
        <h3>Album Name : </h3>&nbsp;&nbsp;&nbsp;
        <input type="text" maxlength="100" name="name"  class="form-control" placeholder="Album Name" ><br>
        </div>
      <div class="clearfix"></div>
      <div class="input-group col-sm-7 mb-3">
          <h3>Select Category :</h3>
        <select class="input-group col-sm-7 mb-3" name="category">
              <%
          while(rs.next()){
                             %> 
        ...
        <h3>About Album : </h3>&nbsp;&nbsp;&nbsp;
        <textarea maxlength="100" name="about" class="form-control"  ></textarea><br>
