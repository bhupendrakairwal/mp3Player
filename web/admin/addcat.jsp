<%-- 
    Document   : addcat
    Created on : Jul 25, 2020, 9:13:50 PM
    Author     : Lenovo
--%>
...
<body>
  ...
  <form action="addcheck.jsp" method="post">
    <div class="input-group col-sm-7 mb-3">
        <input type="text" maxlength="20" name="category"  class="form-control" placeholder="Add category" >
  <div class="input-group-append">
    <span class="input-group-append"><input type="submit" class="btn btn-primary" value="Add"></span>
  </div>
</div>
    </form>
