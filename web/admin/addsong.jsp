<%-- 
    Document   : addsong
    Created on : Jul 25, 2020, 9:20:44 PM
    Author     : Lenovo
--%>
...
<%      String email=null;     
 ...
 if(email==null&&session.getAttribute(email)==null){
       ...
       String Acode=request.getParameter("id1");
...
<body>
 ...
 <form action="songupload.jsp?id=<%=Scode%>&id1=<%=Acode%>" method="post" ENCTYPE='multipart/form-data'>
    <div class="input-group col-sm-7 mb-3">
        <table>
            <tbody>
                <tr>
                    <th>File upload:</th>
       <td><input type="file" maxlength="20" name="uploadFile"  class="form-control" placeholder="file name" ></td><br>
  <div class="input-group-append">
   <td><span class="input-group-append"><input type="submit" class="btn btn-primary" value="submit"></span></td>
  </div>
        </table>
</div>
    </form>   
