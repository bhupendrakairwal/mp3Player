<%-- 
    Document   : playlist
    Created on : Aug 3, 2020, 6:59:56 PM
    Author     : Lenovo
--%>
...
.show {display: block;}
    ...
    try{   
     ...
     Class.forName("com.mysql.jdbc.Driver");
             ...
             Statement lst=cn1.createStatement();
             Statement st1=cn1.createStatement();
             ResultSet rs1;
             ResultSet lrs;
             lrs=lst.executeQuery("select * from list where status=1 and ucode='"+ucode+"'");
             ...
             %>
				<div class="content">
					...
					<div class="products">
						...
						<h5><span>Your</span> Playlist</h5>
                                                <div class="section group">
                                                <%  
                                                    while(lrs.next()){
                                                          String Acode=lrs.getString(2);
                                                            String Catcode=lrs.getString(3);
                                                     rs1=st1.executeQuery("select * from album where status=1 and Acode='"+Acode+"' and ccode='"+Catcode+"' ");
                                                         while(rs1.next()){
                               ...
                               %>
								 ...
								 <h3><%out.println(""+rs1.getString(5)+"");%></h3>
                                                                 ...
                                                                 <div class="button"><span><a href="remove.jsp?Acode=<%=Acode%>&Catcode=<%=Catcode%>">Remove</a></span></div>
             ...
             %>
				<div class="content">
					...
					<div class="products">
						...
						<h5><span>your</span>  Favourits</h5>
                                                <div class="section group">
                                                <%  
                                                    while(rs1.next()){
